...
const Sec2 = () => {
    return (  
        <div className='px-[20px] flex flex-row justify-center items-center w-full mt-[100px]'>
            <div className='w-[50%] flex flex-col justify-start items-start space-y-[13px]'>
                ...
                <p className='bg-black text-white text-[13px] px-[15px] py-[5px] rounded-full'>See More</p>
            </div>
            <div className='w-[50%]'>
